...
@NonNullApi
public class KDMProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KDMProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
